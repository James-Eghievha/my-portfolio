...
export const HeroSection = () => {
    ...
    className= "relative min-h-screen flex flex-col items-center justify-center px-4 pt-20 md:pt-32"
    >
        <div className= "container max-w-4xl mx-auto text-center z-10">
            <div className= "space-y-6 ">
                <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground max-w-5xl mx-auto opacity-0
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col
            ...
            <ArrowDown className="h-5 w-5 text-primary mt-2" />
